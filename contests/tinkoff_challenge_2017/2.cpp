...
//        auto& distance = pair.first;
        ...
        for (auto& move_pair: distances_and_new_vertices) {
            ...
            std::cout << "Considering new_rotation = " << new_rotation << " new_index = " << new_index << " new_vertex_r = " << new_vertex_r << " new_vertex_c = " << new_vertex_c << " old_distance = " << old_distance << std::endl;
            std::cout << "visited = " << (is_visited[new_index] ? 1 : 0) << std::endl;
            std::cout << "blocked = " << (is_blocked[new_vertex_c * n + new_vertex_r] ? 1 : 0) << std::endl;
            if (!is_visited[new_index] && !is_blocked[new_vertex_c * n + new_vertex_r]) {
                int addon_points = 0;
                if (new_rotation != rotation) {
                    addon_points = 1;
                }
                std::cout << "addon_points = " << addon_points << std::endl;
